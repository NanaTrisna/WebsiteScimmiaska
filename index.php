...
<body>
        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#about"><i class="bx bx-user"></i> <span>Sejarah</span></a></li>
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Line-Up & List Lagu</span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i> Dokumentasi</a></li>
                    <li><a href="#contact"><i class="bx bx-envelope"></i> Contact us</a></li>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            ...
            <p><span class="typed" data-typed-items="<?php
...
while($data4=mysqli_fetch_array($runquery4)){
    ?>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <h3 class="resume-title">List Lagu</h3>
...
-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="credits">
                @Copyright by 
                <a href="#">18111116_NanaTrisna<br>TIF-RP-18-CNS-A_UASWEB1</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
