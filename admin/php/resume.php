...
?> 
  ...
  <option value="e" selected>Line-Up</option>
  <option value="pe">List Lagu</option>
</select></div>
   ...
   <div class="form-group col-md-4">
    ...
    <input type="text" name="year" class="form-control" id="website" placeholder="Masukan Keterangan" required>
  </div>
...
<!--     <label class="text-white">submi</label>-->
      <input type="submit" name="addtoresume" class="btn btn-primary form-control" value="Masukan Data"> 
   </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
    $cat = $data2['category']=='e'?$cat="Line-Up":$cat="List Lagu";
    ?>
     <tr>
  ...
  <option value="pe">List Lagu</option> 
                      <?php  }else{ ?>
                            <option value="e">Line-Up</option>
  <option value="pe" selected>List Lagu</option>
                    <?php    }
                        ?>
   ...
   <div class="form-group col-md-4">
    <label for="website">Keterangan</label>
    <input type="text" name="year" value="<?=$data2['year']?>" class="form-control" id="website" placeholder="Masukan Keterangan">
  </div>
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Deksripsi (biarkan kosong jika Anda tidak mau)</label>
