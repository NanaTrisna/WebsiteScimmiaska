...
<img src="../assets/img/<?=$data['icon']?>" class="img-thumbnail ooo">
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      ...
      <input type="name" name="title" value="<?=$data['title']?>" class="form-control" id="name" placeholder="Masukan Website Title">
    </div>
    
   
    
    <div class="form-group col-md-12">
      <label for="email">Keywords (masukan dengan menggunakan ',' comma)</label>
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" value="<?=$data['description']?>" name="description" class="form-control" id="email" placeholder="Website Portfolio">
    </div>
    <div class="form-group ml-auto">
        <input type="submit" name="seo" class="btn btn-primary" value="Perbarui">
    </div>
