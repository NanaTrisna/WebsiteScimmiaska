...
?> 
    ...
    <input type="text" name="website" value="<?=$data['website']?>" class="form-control" id="website" placeholder="https://bebas.com">
         ...
         <hr>
         <h4 ID="skillsection">Advantage</h4>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Edit Advantage</h6>
      ...
      <div class="modal-body" id="skilleditbox">
       ...
       <input type="hidden" name="id" value="<?=$data2['id']?>">
        <div class="form-row">
            <div class="form-group col-md-6">
    <label for="website">Advantage</label>
    <input type="text" name="skill" value="<?=$data2['skill']?>" class="form-control" id="website" placeholder="Masukan Data">
  </div>
       <div class="form-group col-md-6">
  ...
  Delete
    ...
    <label for="sn">Advantage</label>
    <input type="text" name="skill" class="form-control" id="website" placeholder="Masukan Data" required>
   ...
   <div class="form-group col-md-2">
     <label class="text-white">submit</label>
      <input type="submit" name="addskill" class="btn btn-primary form-control" value="Tambah Data"> 
   </div>
